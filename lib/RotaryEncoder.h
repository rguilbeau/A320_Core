// -----
//
// ! FORK ! Updated to use InputInterface
//
...
public:
  ...
  // ----- Constructor -----
  RotaryEncoder(InputInterface *pin1, InputInterface *pin2, LatchMode mode = LatchMode::FOUR0);
...
private:
  InputInterface *_pin1;
  InputInterface *_pin2; // Arduino pins used for the encoder.
